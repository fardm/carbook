...
export const fa = {
  ...
  account: {
    ...
    setPasswordTitle: "تنظیم گذرواژه",
    setPasswordButton: "تنظیم گذرواژه",
    setPasswordSuccess: "گذرواژه با موفقیت تنظیم شد. اکنون می‌توانید با ایمیل و گذرواژه وارد شوید.",
    currentPasswordLabel: "گذرواژه فعلی",
    currentPasswordPlaceholder: "گذرواژه فعلی خود را وارد کنید",
    ...
    errors: {
      ...
      shortPassword: "گذرواژه باید حداقل ۶ کاراکتر باشد.",
      emailInUse: "با این ایمیل قبلاً حساب ساخته شده است. وارد شوید.",
      invalidCredentials: "ایمیل یا گذرواژه اشتباه است.",
      network: "اتصال برقرار نشد؛ اتصال اینترنت را بررسی کنید و دوباره تلاش کنید.",
      rateLimited: "تلاش‌های بیش از حد؛ چند لحظه بعد دوباره امتحان کنید.",
      sessionExpired: "نشست شما منقضی شده است؛ دوباره وارد شوید.",
      requiredPassword: "گذرواژه فعلی را وارد کنید.",
      passwordMismatch: "گذرواژه جدید و تکرار آن یکسان نیستند.",
      noSession: "نشست فعال یافت نشد؛ دوباره وارد شوید.",
      migrationFailed: "انتقال داده‌ها انجام نشد؛ داده‌های محلی دست‌نخورده باقی ماندند. دوباره تلاش کنید.",
  ...
  reminders: {
    ...
    editTitle: "ویرایش یادآوری",
    addTitle: "افزودن یادآوری",
    addGeneralTitle: "افزودن یادآوری عمومی",
    addServiceTitle: "افزودن یادآوری سرویس",
    generalReminder: "یادآوری عمومی",
    serviceReminder: "یادآوری سرویس",
    noReminders: "هنوز یادآوری‌ای برای این خودرو ثبت نشده است.",
    noVehicles: "برای ثبت یادآوری، ابتدا یک خودرو اضافه کنید.",
    goToVehicles: "رفتن به خودروها",
    vehicleLabel: "خودرو",
    titleLabel: "عنوان یادآوری",
    ...
    typeLabel: "نوع یادآوری",
    typeDate: "تاریخی",
    typeMileage: "کیلومتری",
    typeDateMileage: "تاریخی و کیلومتری",
    typeDateHint: "یادآوری در یک تاریخ مشخص فعال می‌شود.",
    typeMileageHint: "یادآوری با رسیدن به کیلومتر مشخص فعال می‌شود.",
    typeDateMileageHint: "هرکدام از دو شرایط زودتر برسد یادآوری فعال می‌شود.",
    dueDateLabel: "تاریخ یادآوری",
    dueMileageLabel: "کیلومتر یادآوری",
    dateOptionalHint: "تاریخ اختیاری است؛ می‌توانید فقط تکرار را انتخاب کنید.",
    serviceLabel: "سرویس",
    selectService: "انتخاب سرویس",
    currentOdometerHint: "کیلومتر فعلی خودرو:",
    notifyBeforeLabel: "اعلان پیش از موعد",
    advanceDaysLabel: "فاصله زمانی",
    advanceKmLabel: "فاصله کیلومتری",
    daysBefore: "روز قبل",
    kmBefore: "کیلومتر قبل",
    atDueDate: "روز موعد",
    atDueMileage: "در کیلومتر موعد",
    repeatLabel: "تکرار",
    repeatNone: "یک‌بار",
    repeatDaily: "روزانه",
    repeatWeekly: "هفتگی",
    ...
    weekday6: "جمعه",
    enabledLabel: "فعال",
    enabledHint: "یادآوری غیرفعال اعلانی نمی‌فرستد.",
    filterAll: "همه",
    ...
    statusDueSoon: "به‌زودی",
    statusDueToday: "امروز سررسید",
    statusDue: "سررسید",
    statusOverdue: "گذشته",
    statusDisabled: "غیرفعال",
    remainingDays: "روز مانده",
    pastDays: "روز گذشته",
    remainingKm: "کیلومتر مانده",
    ...
    errorSyncKmUnavailable: "این سرویس کیلومتر پیشنهادی ندارد؛ نوع یادآوری را تغییر دهید.",
    errorRepeatWeekday: "روز هفته را انتخاب کنید.",
  ...
  notifications: {
    ...
    settingsHint:
      "برای دریافت اعلان یادآوری‌ها در مرورگر، دسترسی اعلان‌ها لازم است.",
    stateEnabled: "اعلان‌ها فعال است.",
    stateDefault: "اعلان‌ها فعال نشده است.",
    stateDenied:
      "دسترسی اعلان‌ها توسط مرورگر رد شده است. برای فعال‌سازی آن از تنظیمات مرورگر یا سایت استفاده کنید.",
    stateUnsupported: "مرورگر شما از اعلان پشتیبانی نمی‌کند.",
    enableButton: "فعال کردن اعلان‌ها",
    revokeHint:
      "برای غیرفعال کردن اعلان‌ها، از تنظیمات دسترسی اعلان‌های این سایت در مرورگر استفاده کنید.",
    enableGranted: "اعلان‌ها فعال است.",
    promptTitle: "فعال کردن اعلان‌ها",
    promptBody: "برای دریافت اعلان یادآوری‌های خودرو، دسترسی اعلان‌های مرورگر را فعال کنید.",
    promptEnable: "فعال کردن اعلان‌ها",
    promptLater: "فعلاً نه",
    promptLaterNote:
      "یادآوری ذخیره شد، اما تا زمانی که دسترسی اعلان‌ها فعال نشود اعلانی دریافت نخواهید کرد.",
    promptDeniedNote:
