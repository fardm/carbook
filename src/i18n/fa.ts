...
export const fa = {
  ...
  account: {
    ...
    emailConfirmationSent: "ایمیل تأیید برای شما ارسال شد؛ پس از تأیید ایمیل وارد شوید.",
    errors: {
      ...
      emailNotConfirmed: "ایمیل شما تأیید نشده است. ایمیل تأیید را بررسی کنید.",
